<template>
  <section class="skills" id="skills">
    <div class="main-text">
      <h2 ref="SkillsText">My Skills</h2>
    </div>
    ...
    <div class="skills-content">
      ...
      <div class="box">
        ...
        <p>
          ...
          building and maintaining the technology that powers the front-end, such as
          databases, server logic, and APIs. Back-end developers work on server
          configurations, data management, and application performance, ensuring that the
          user-facing side operates smoothly and efficiently behind the scenes.
        </p>
      </div>
      ...
      <div class="box">
        ...
        <p>
          ...
          of activities, both technical and recreational. This skill encompasses engaging
          in diverse interests such as games, creative projects, and community
          initiatives. Those with dynamic involvement thrive in multiple contexts,
          leveraging their broad experiences to contribute effectively and adapt to
          various challenges. Their enthusiasm for a wide range of pursuits fosters
          creativity and a comprehensive approach to problem-solving.
        </p>
      </div>
    </div>
  </section>
...
onMounted(() => {
  ...
  observer.observe(SkillsText.value);
});
</script>
